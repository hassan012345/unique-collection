...
const MenCollection = () => {
  ...
  return (
    <div className="bg-white py-8 px-4 text-center md:mx-auto">
        ...
        {categories.map((category, index) => (
          <div key={index} className="relative flex-1">
            <Image
              ...
              priority
            />
            <p className="absolute bottom-4 left-1/2 transform -translate-x-1/2 px-3 py-1 rounded text-xl font-medium text-white">
              {category.label}
            </p>
          </div>
        ))}
