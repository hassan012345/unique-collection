...
var UniqueMenCollection = function () {
    ...
    return (React.createElement("section", { className: "py-12 px-4 md:px-8 bg-white" },
        React.createElement("div", { className: "max-w-7xl mx-auto" },
            React.createElement("h2", { className: "text-3xl md:text-4xl font-serif text-center mb-6" }, "Unique Women Collection"),
            React.createElement("nav", { className: "flex flex-wrap justify-center space-x-4 md:space-x-6 text-gray-600 text-sm md:text-base mb-8" },
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "Unstitched Suits"),
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "New Arrival"),
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "Ready Made Suits"),
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "3 Piece Suits"),
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "Kurti Collection"),
                React.createElement("a", { href: "#", className: "hover:text-[#1B4B3A]" }, "Formal Wear")),
