...
function SwiperCmp() {
    ...
    return (React.createElement("section", { className: "py-8 px-4 md:px-8 bg-white max-w-7xl mx-auto" },
        React.createElement("h2", { className: "text-3xl font-bold mb-6 text-center md:text-left" }, "Unique Women's Collection"),
        React.createElement("div", { className: "flex items-center justify-between mb-6 overflow-x-auto pb-3 scrollbar-hide" },
            React.createElement("div", { className: "flex gap-3 whitespace-nowrap" },
                ...
                React.createElement("button", { className: "hover:bg-gray-100 px-6 py-2 rounded-full text-sm font-medium text-gray-700 border border-gray-300" }, "Unstitched"),
            ...
            React.createElement(react_1.Swiper, { modules: [modules_1.Navigation], navigation: {
                ...
                React.createElement("div", { className: "group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all" },
                    React.createElement("div", { className: "relative h-[380px] md:h-[420px] w-full" },
                        React.createElement(image_1["default"], { src: product.image, alt: product.title, fill: true, className: "object-cover" }),
                    ...
                    React.createElement("div", { className: "p-4" },
                        ...
                        React.createElement("p", { className: "text-lg font-semibold text-[#184335] mt-1" }, product.price))))); })),
            React.createElement("button", { className: "swiper-button-prev absolute -left-5 md:-left-6 top-1/2 -translate-y-1/2 z-10 bg-white w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:shadow-xl hover:scale-110 transition-all" },
                React.createElement(fa6_2.FaChevronLeft, { color: "black" })),
            React.createElement("button", { className: "swiper-button-next absolute -right-5 md:-right-6 top-1/2 -translate-y-1/2 z-10 bg-white w-12 h-12 rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:shadow-xl hover:scale-110 transition-all" },
                React.createElement(fa6_1.FaChevronRight, { color: "black" })))));
}
