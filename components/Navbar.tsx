...
//       <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
//         <path d="M3 3h2l2.68 10.39a2 2 0 001.94 1.61h7.72a2 2 0 001.94-1.51L20.6 7H6" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
//         <circle cx="9" cy="20" r="1.2" fill="white"/>
//         <circle cx="17" cy="20" r="1.2" fill="white"/>
//       </svg>
//       {count > 0 && (
//         <span className="absolute -top-1.5 -right-1.5 bg-[#FFB86A] text-black text-[9px] font-bold rounded-full w-4 h-4 flex items-center justify-center">
//           {count}
//         </span>
//       )}
//     </div>
...
//   return (
//     <nav className="w-full bg-[#184335] sticky top-0 z-50">
//       <div className="max-w-[1440px] mx-auto px-5 lg:px-20 py-4 flex items-center justify-between">
//         {/* Logo */}
...
//               key={item.label}
//               href={item.href}
//               className="flex items-center gap-1 text-white text-sm hover:text-[#B7C5C0] transition-colors"
...
//           <button className="text-white hover:text-[#B7C5C0] transition-colors" aria-label="Search">
//             <SearchIcon />
//           </button>
//           <button className="text-white hover:text-[#B7C5C0] transition-colors" aria-label="Account">
//             <UserIcon />
//           </button>
//           <button className="text-white hover:text-[#B7C5C0] transition-colors" aria-label="Cart">
//             <CartIcon count={2} />
//           </button>
//         </div>
...
//       {/* Mobile Menu */}
//       {mobileOpen && (
//         <div className="lg:hidden bg-[#184335] border-t border-[#245749]">
//           <div className="px-5 py-4 flex flex-col gap-4">
//             {NAV_ITEMS.map((item) => (
//               <Link
//                 key={item.label}
//                 href={item.href}
//                 className="text-white text-base py-2 border-b border-[#245749] flex items-center justify-between"
...
//               <button className="text-white" aria-label="Account"><UserIcon /></button>
//             </div>
//           </div>
//         </div>
//       )}
